    ...
    <div>
      ...
      <div style={{ marginBottom: '10px' }}>
        {!(chequebookAddress?.chequebookAddress && chequebookBalance?.totalBalance.toBigNumber.isGreaterThan(0)) && (
          <div>
            <span>
              Your chequebook is either not deployed or funded. To run the node you will need BSC and PEN token on the BSC
              network. You may need to aquire PEN. To pay the transaction fees, you will also need BSC token.
            </span>
          </div>
        )}
      </div>
