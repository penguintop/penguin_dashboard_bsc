import { ChequebookAddressResponse } from '../penjs'
import {
  ChequebookBalance,
...
export const useStatusNodeVersion = (): StatusNodeVersionHook => {
  ...
  return {
    ...
    //     }),
    // ),
    isOk: isLatestBeeVersion,
    userVersion: nodeHealth?.version,
    latestVersion,
    latestUrl: latestBeeRelease?.html_url || 'https://github.com/penguintop/penguin/releases/latest',
    isLatestBeeVersion,
  }
}
